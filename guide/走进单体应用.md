...
[**开始学习**](https://www.funtl.com/zh/myshop1/)

## Spring 的事务管理

事务原本是数据库中的概念，用于数据访问层。但一般情况下，需要将事务提升到业务层，即 Service 层。这样做是为了能够使用事务的特性来管理具体的业务。

[**开始学习**](https://www.funtl.com/zh/spring-transaction/)

## 解决模块间通信问题

[**开始学习**](https://www.funtl.com/zh/apache-http-client/)

## 项目实战 MyShop（下）

[**开始学习**](https://www.funtl.com/zh/myshop2/)

## 补充知识点

[**开始学习**](https://www.funtl.com/zh/supplement1/)
