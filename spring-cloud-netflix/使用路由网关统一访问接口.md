    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.dfd.hello.spring.cloud.zuul.ZuulApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.dfd.hello.spring.cloud.zuul;
...
```java
package com.dfd.hello.spring.cloud.zuul.fallback;
