    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.dfd.myshop.service.provider.item.MyShopServiceProviderItemApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.dfd.myshop.service.provider.item;
...
```java
package com.dfd.myshop.service.provider.item.controller;

import com.dfd.myshop.commons.domain.TbItem;
import com.dfd.myshop.commons.service.TbItemService;
