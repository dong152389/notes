...
```java
package com.dfd.myshop.commons.dto;
...
```java
package com.dfd.myshop.service.reg.controller;

import com.dfd.myshop.commons.domain.TbUser;
import com.dfd.myshop.commons.dto.AbstractBaseResult;
import com.dfd.myshop.commons.dto.BaseResultFactory;
import com.google.common.collect.Lists;
...
public class TestController {
    ...
    public AbstractBaseResult getById(HttpServletRequest request, @PathVariable long id) {
        ...
        if (id == 1) {
            ...
            return BaseResultFactory.build(HttpStatus.UNAUTHORIZED.value(), "参数类型错误", "ID 只能为 1", applicationContext.getEnvironment().getProperty("logging.level.com.dfd.myshop"));
        }
    }
