    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.dfd.hello.spring.cloud.alibaba.nacos.consumer.NacosConsumerApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.dfd.hello.spring.cloud.alibaba.nacos.consumer;
...
```java
package com.dfd.hello.spring.cloud.alibaba.nacos.consumer.config;
...
```java
package com.dfd.hello.spring.cloud.alibaba.nacos.consumer.controller;
...
![img](./img/Lusifer_20190105071118.png)
...
![img](./img/Lusifer_20190105071304.png)