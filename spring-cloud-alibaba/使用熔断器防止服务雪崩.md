...
![img](./img/Lusifer201901080205008.png)
...
import com.dfd.hello.spring.cloud.alibaba.nacos.consumer.feign.service.fallback.EchoServiceFallback;
...
```java
package com.dfd.hello.spring.cloud.alibaba.nacos.consumer.feign.service.fallback;
