    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.dfd.hello.spring.cloud.alibaba.rocketmq.consumer.RocketMQConsumerApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.dfd.hello.spring.cloud.alibaba.rocketmq.consumer.receive;
...
```java
package com.dfd.hello.spring.cloud.alibaba.rocketmq.consumer;
